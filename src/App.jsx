          ...
          <div className="flex flex-col flex-grow border-l border-r">
            <div>
              <form className="w-3/5 bg-[#FFFFFF] py-4 pl-8">   
                <label htmlFor="default-search" className="text-sm font-medium text-gray-900 sr-only dark:text-white">Search or type</label>
                <div className="relative">
                  ...
                  <input type="search" id="default-search" className="block w-full py-1 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#F4F4F4] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search or type" required />
                </div>
              </form>
            </div>
            ...
            <div className="flex flex-col bg-[#F4F4F4] h-[60%] py-4">
              ...
              <div className="flex flex-col gap-3 text-[#FFFFFF] bg-cover bg-center mx-4 border rounded-xl pt-4 px-4 pb-4" style={{ backgroundImage: `url(${createcoursebox})` }}>
                ...
                <button type="button" onClick={() => setShowInputForm(true)} className="text-white w-24 bg-black gap-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-1 py-1 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Create
                ...
                <div className="flex flex-grow">
                  <div className="h-40 w-40 border-4 font-inter bg-[#E2D5FF] text-[#962DFF] border-[#962DFF] rounded-xl  flex justify-center items-center">
                    <div className="flex flex-col justify-center items-center">
                      <div onClick={() => setShowInputForm(true)} className="text-4xl cursor-pointer">+</div>
                      <div>Create New</div>
                      <div>Course</div>
                    </div>
                  </div>
              ...
              <div className="flex justify-center">
                <div className="relative flex items-center justify-center w-40 h-40">
                  <svg className="absolute w-full h-full" viewBox="0 0 120 120">
                    <circle className="text-gray-300" strokeWidth="10" stroke="currentColor" fill="transparent" r={circleRadius} cx="60" cy="60" />
                    <circle className="text-[#962DFF]" strokeWidth="10" strokeDasharray={circumference} strokeDashoffset={strokeDashoffset} strokeLinecap="round" stroke="currentColor" fill="transparent" r={circleRadius} cx="60" cy="60" />
                  </svg>
                  <img src={avatar} alt="Center Image" className="absolute w-16 h-16 rounded-full" />
                </div>
              </div>
              <div className="flex flex-col text-center font-medium">
                <div>Good Morning name</div>     
                <div className="text-[#7E7E7E] text-base">continue your journey and achieve Your Target</div>   
              </div>
...
<div className="border rounded-full px-2 text-[#9E9E9E]">
  +
</div>
